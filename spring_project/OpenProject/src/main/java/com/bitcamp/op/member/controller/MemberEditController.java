...
public class MemberEditController {
	...
	@GetMapping
	public String form (@RequestParam("idx") int idx, Model model) {
	...
	public String edit(EditRequest editRequest, HttpServletRequest request) throws IllegalStateException, IOException {
