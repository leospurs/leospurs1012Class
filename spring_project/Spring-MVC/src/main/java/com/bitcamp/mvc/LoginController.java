...
public class LoginController {
	...
	public String getLoginForm(Model model,
			...
			@RequestParam(value = "url", required = false) String url1, HttpServletRequest request) {
	...
	@PostMapping
	public String login(String uid, String pw, String rurl, String uname, HttpSession session) {
