...
//	Calculator 클래스를 정의해봅시다.
	...
	// final 변수 앞에 -> 상수 또는 크래스 앞에 사용
	// 클래스 앞에 사용 -> 상속의 대상이 아니다.
	// java에서 상수: 변수에 최초 초기화 된 값을 바꾸지 못한다.
...
//	⑦ main() 메소드를 정의하고 각각의 메소드를 호출해서 결과를 콘솔에 출력해봅시다.
	...
	public static void main(String[] args) {
		...
		System.out.println("UserName = " + cal.USER_NAME);
		
		//cal.USER_NAME = "이강인"; 상수변경은안된다.
		cal.plus(3,5);
...
//		에 추가해봅시다.
		...
		System.out.println("==============================");
		System.out.println("원의둘레와 넓이를 구합니다.\n반지름을 입력해 주세요.");
		System.out.print("> "); 
