...
public class Exam02 {
	...
	//////////해당 클래스의 생성자 위치는 변수 바로 아래에 위치한다/////////////
	// 생성자
	...
	public Exam02(String name, String phoneNumber, String major, int grade, String email, String birthday, String address) {
		this.name = name;
	...
	public Exam02(String name, String phoneNumber, String major, int grade, String email) {
//		this.name = name;
//		this.phoneNumber = phoneNumber;
//		this.major = major;
//		this.grade = grade;
