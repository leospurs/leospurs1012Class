...
<body>
	<div id="main_wrap">
        ...
        <section>
            <article>
                <h3 class="title_font margin_tb_5">스페이스X 유인 우주선 '스타십', 22년 1월 첫 궤도비행 예정</h3>
                <div class="margin_tb_5">2021-11-19 10:38:15</div>
                <img src="../images/imi2.jpeg" class="margin_tb_5">
                <p class="margin_tb_5 lineheight_180per">일론 머스크가 이끄는 우주기업 스페이스X의 유인 우주선 '스타십'이 내년 1월 첫 번째 지구 궤도비행에
                    ...
                    18일(현지시간) <테크크런치>
                        <엔가젯> 등 외신에 따르면 일론 머스크는 미 국립과학원 발표에서 "올해 12월 여러 테스트를 거쳐 내년 1월 스타십을 발사하는 것이 목표"라며 "성공하지 못할
                            ...
                            승인이 떨어지면 예정대로 1월 중 첫 지구궤도 시험 발사가 이뤄질 수 있게 된다. 2023년에는 화물 운송이 가능한 수준을 목표로 한다.


                            한편 스페이스X는 지난 13일 스타십 발사에 필요한 랩터엔진 6개를 동시에 가동하는 정지발사 시험에 성공하며 유인 우주선 발사에 대한 기대감을 높였다.</p>
            </article>
